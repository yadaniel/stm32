...
/* Call the clock system initialization function.*/
    bl  SystemInit  /* branch with link ... execution will return */
...
/*
    $ arm-none-eabi-nm.exe CCMRAM_code.elf | grep -ie "ccmram"
    100000b8 T _eccmram
    10000000 T _sccmram
    08002754 A _siccmram
*/

  ldr r0, =_sccmram         /* start address within CCMRAM = 0x10_000_000 */
  ldr r1, =_eccmram         /* end address within CCMRAM ... depends on content placed in section */
  ldr r2, =_siccmram        /* start address within FLASH */
  movs r3, #0               /* offset */
  b LoopCopyCCMDataInit     /* unconditional branch */

CopyCCMDataInit:
  ldr r4, [r2, r3]      /* r4 = *(r2 + r3) ... u32 from FLASH */
  str r4, [r0, r3]      /* *(r0 + r3) = r4 ... u32 to CCMRAM */
  adds r3, r3, #4       /* r3 += 4 */

LoopCopyCCMDataInit:
  adds r4, r0, r3       /* r4 = r0[r3] ... holds the address to copy to */
  cmp r4, r1            /* end address reached? */
  bcc CopyCCMDataInit   /* address in r4 not used within CopyCCMDataInit */
