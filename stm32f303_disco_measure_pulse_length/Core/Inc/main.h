...
#define PC8_NOEXTI_Pin GPIO_PIN_8
#define PC8_NOEXTI_GPIO_Port GPIOC
#define PC9_OUT_Pin GPIO_PIN_9
#define PC9_OUT_GPIO_Port GPIOC
#define PA8_EXTI_Pin GPIO_PIN_8
#define PA8_EXTI_GPIO_Port GPIOA
#define PA8_EXTI_EXTI_IRQn EXTI9_5_IRQn
